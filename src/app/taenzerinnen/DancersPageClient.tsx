...
export default function DancersPageClient({
  initialDancers,
  initialTotal,
  initialQueryString,
}: {
  ...
  useEffect(() => {
    ...
    void fetchDancers();
  }, [searchParams, initialQueryString]);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="mt-1 text-sm text-[var(--muted)]">{isLoading ? "Lade…" : `${total} Tänzerinnen gefunden`}</div>
      </div>
