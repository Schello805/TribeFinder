...
const profileSchema = z.object({
  ...
  dancerGivesWorkshops: z.boolean().optional(),
  dancerBookableForShows: z.boolean().optional(),
  dancerWorkshopConditions: z.string().optional().nullable(),
  ...
  try {
    ...
    const updateArgs = {
      ...
      data: {
        ...
        dancerGivesWorkshops:
          typeof data.dancerGivesWorkshops === "boolean" ? data.dancerGivesWorkshops : undefined,
        dancerBookableForShows:
          typeof data.dancerBookableForShows === "boolean" ? data.dancerBookableForShows : undefined,
        dancerWorkshopConditions: data.dancerWorkshopConditions,
