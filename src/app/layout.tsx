              ...
              <div className="container mx-auto px-4 max-w-6xl">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-left">
                  <div className="md:col-span-1">
                    ...
                    <p className="mt-3 text-xs" style={{ color: "var(--footer-fg)" }}>
                      &copy; {new Date().getFullYear()} TribeFinder.
                    </p>
                    ...
                    {appVersion || appCommit ? (
                      <div className="mt-3 text-xs text-[var(--footer-muted)] break-all">
                        ...
                        <Link
                          href="/changelog"
                          className="underline underline-offset-2 hover:text-[var(--footer-fg)] transition-colors"
                        >
                  ...
                  <div className="md:col-span-1">
                    <div className="text-xs font-semibold text-[var(--footer-fg)]">Rechtliches</div>
                    <div className="mt-3 flex flex-col gap-2 text-xs">
                      <Link href="/impressum" className="hover:text-[var(--footer-fg)] transition-colors">
                        Impressum
                      </Link>
                  ...
                  <div className="md:col-span-1">
                    <div className="text-xs font-semibold text-[var(--footer-fg)]">Mehr</div>
                    <div className="mt-3 flex flex-col gap-2 text-xs">
                      <Link href="/hilfe" className="hover:text-[var(--footer-fg)] transition-colors">
                        Hilfe
                      </Link>
                      <Link href="/links" className="hover:text-[var(--footer-fg)] transition-colors">
                        Links
                      </Link>
                      <Link href="/marketing" className="hover:text-[var(--footer-fg)] transition-colors">
                        Marketing
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-1">
                    <div className="text-xs font-semibold text-[var(--footer-fg)]">Community</div>
                    ...
                    {session?.user?.role === "ADMIN" && (
                      <div className="mt-4">
                        <Link
                          href="/admin"
                          className="text-xs font-bold text-[var(--link)] hover:opacity-90 transition-colors inline-flex items-center gap-1"
                        >
                ...
                {process.env.NODE_ENV !== "production" ? (
                  <div className="mt-8 text-center text-xs text-[var(--footer-muted)]">
