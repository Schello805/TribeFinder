  ...
  return (
    <div className="min-h-[40vh] flex items-center justify-center">
      <div className="text-center max-w-md mx-auto p-8 bg-[var(--surface)] text-[var(--foreground)] rounded-xl shadow-sm border border-[var(--border)]">
        <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-red-600/15 border border-red-500/30 mb-4">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <Link
            href="/"
            className="px-4 py-2 bg-[var(--surface)] text-[var(--foreground)] rounded-lg border border-[var(--border)] hover:bg-[var(--surface-hover)] transition text-sm font-medium"
          >
            Startseite
          </Link>
        </div>
